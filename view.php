...
/**
 * The main Student Dashboard view
 *
...
$html = html_writer::tag('div', '',['id' => 'assessmentSummaryContainer']);
$html .= html_writer::tag('div', '',['id' => 'courseTabContainer']);
...
if ($tab == 1) {
    ...
    $filteroptions = '<div id="forborder" style="border:1px solid #ccc; padding-top:8px; margin-top:-17px;">
                          <div style="width:97%; margin:0 12px;">
                              <label>Sort by:
                                  <select onchange="document.location.href=this.value" name="grades_sortby" aria-controls="grades">
...
$pdflink = "downloadspdetails.php?spdetailstype=pdf&coursestype=";
$excellink = "downloadspdetails.php?spdetailstype=excel&coursestype=";
